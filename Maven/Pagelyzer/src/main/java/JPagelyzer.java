...
public class JPagelyzer {
    ...
    public void changeDetection(String url1,String url2,String browser1,String browser2,String mode,String cFile,String cRfile) throws URISyntaxException {
        //cfile = "/ext/ex_images.xml"
    	String resourcePath = getClass().getResource(cRfile + cFile).getPath();
    	
    	
       
        MarcAlizer marcalizer = new MarcAlizer();
      
        marcalizer.init(new File( resourcePath), resourcePath.replace(cFile, ""));
    ...
    **/
    public static void main(String[] args) throws URISyntaxException {
        String url1="http://www.lip6.fr";
        String url2="http://www.lip6.fr";
        String url="";
        String ofile="";
        ...
        */
        ...
        switch(cmd.getOptionValue("get")) {
            case "score":
                ...
                System.out.println("Using parameters found in " + cfile);
                System.out.println("Change detection. Mode: "+mode+". Port:" + JPagelyzer.port+". "+JPagelyzer.seleniumStat);
                pagelyzer.changeDetection(url1,url2,browser1,browser2,mode,cfile,cfilesub);
                break;
            case "screenshot":
                ofile ="image.png";
